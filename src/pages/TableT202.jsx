...
export default function TableT202() {
  ...
  // T-202 table seats data - 4 seats
          ...
          <div className="px-3 md:px-4 py-3">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-2xl font-bold text-gray-800">Table T-202 Management</h1>
              </div>
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Table T-202 Management</p>
                </div>
              </div>
